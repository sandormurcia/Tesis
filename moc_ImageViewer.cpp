...
**
** Created: Sat Feb 11 18:11:05 2012
...
static const char qt_meta_stringdata_ImageViewer[] = {
    "ImageViewer\0\0open()\0closeFile()\0"
    "selectArea()\0processArea()\0cancelSelection()\0"
    "about()\0item,column\0"
    "openRepositoryImage(QTreeWidgetItem*,int)\0"
    "index\0changeFilterValues(int)\0"
};
...
int ImageViewer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: selectArea(); break;
        case 3: processArea(); break;
        case 4: cancelSelection(); break;
        case 5: about(); break;
        case 6: openRepositoryImage((*reinterpret_cast< QTreeWidgetItem*(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 7: changeFilterValues((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 8;
    }
